...
//    private static final Logger log= LogManager.getLogger();
        ...
        try
        {
            ...
            if (auth.isAuthenticated()) {
                if (customerUsersDetailsService.getUserDetails().getStatus().equalsIgnoreCase("true")) {
                    return new ResponseEntity<String>("{\"token\":\""+jwtUtil.generateToken(customerUsersDetailsService.
                            getUserDetails().getEmail(),customerUsersDetailsService.getUserDetails().getRole())+"\"}",
                    HttpStatus.OK);
                } else {
    ...
    @Override
    public ResponseEntity<String> forgotPasssword(Map<String, String> requestMap) {
        try {
